  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-all duration-200 ${
        open ? 'pointer-events-auto bg-slate-900/40 opacity-100' : 'pointer-events-none bg-slate-900/0 opacity-0'
      }`}
      onClick={onCancel}
      role="dialog"
      aria-modal="true"
    ...
    >
      <div
        className={`w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-xl transition-all duration-200 ${
