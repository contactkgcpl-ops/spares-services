        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-[12.5px] md:text-[13.5px] text-blue-100/80 font-medium max-w-lg leading-relaxed">
              Leading manufacturer and global exporter of heavy-duty spice grinding mills, masala pulverizers, automatic powder packaging machines, liquid filling plants, and dal mill machinery with 18+ years of engineering excellence.
            </p>

            <div className="flex flex-wrap gap-4 pt-2">
              <Link to="/spares-service/machineries" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 md:px-6 md:py-3 rounded-[14px] font-bold transition-all duration-300 transform hover:scale-[1.04] shadow-lg shadow-blue-600/30 text-[11.5px] md:text-[12.5px]">
                Explore Machineries
